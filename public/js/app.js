...
function () {
  ...
  _createClass(BirdboardForm, [{
    ...
    value: function submit(endpoint) {
      var resquestType = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'post';
      return axios[resquestType](endpoint, this.data()).catch(this.onFail.bind(this)).then(this.onSuccess.bind(this));
    }
  }, {
    key: "onSuccess",
...
__webpack_require__(/*! E:\xampp\htdocs\birdboard\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! E:\xampp\htdocs\birdboard\resources\sass\app.scss */"./resources/sass/app.scss");
